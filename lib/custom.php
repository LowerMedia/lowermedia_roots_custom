...
function lowermedia_website_link_meta_box( $object, $box ) { 
	...
	<p>
		...
		<br /><br />
		http://<input style='width:100px' class="widefat" type="text" name="lowermedia-website-link" id="lowermedia-website-link" value="<?php echo get_post_meta( $object->ID, 'lowermedia_website_link', true ); ?>" size="15" />
	</p>
<?php }
